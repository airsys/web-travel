...
<!-- Horizontal Form -->
  <div class="box box-info">
    ...
    <!-- form start -->
    	<form id="form" class="form-horizontal" action="<?= base_url() ?>ppob/bayar" method="post" novalidate>
	      ...
	      <?php 
	      	if($data_pulsa != NULL){
				  ...
				  <div class="box-footer">
			        <div class="col-md-6">
			          <a href="<?= base_url().'ppob/pulsa/'.$data_pulsa['id']; ?>" id="btn-back" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> BACK</a>
