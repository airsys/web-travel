...
<head>
    ...
    <!-- Main Style -->
    <link id="main-style" rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/css/style.css">
    
    <!-- Custom Styles -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/css/custom.css">

    <!-- Updated Styles -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/css/updates.css">
    ...
    <!-- CSS for IE -->
    <!--[if lte IE 9]>
        <link rel="stylesheet" type="text/css" type="text/css" href="<?php echo base_url() ?>assets/css/ie.css" />
    <![endif]-->
                ...
                <div class="container">
                    <h1 class="logo navbar-brand">
                        <a href="index.html" title="Travelo - home">
                            <img src="<?php base_url()?>assets/images/logo.png" alt="Travelo HTML5 Template" />
						<img src="<?php base_url()?>assets/images/icon/blank.png" alt="Travelo HTML5 Template" />
                        </a>
                    </h1>
